...
func (m *defaultMovieReleaseTopStatModel) Delete(ctx context.Context, id int64) error {
	...
	}, rudyGcMovieReleaseTopStatAggModeScopeKeyAggTypeAggKeyKey, rudyGcMovieReleaseTopStatIdKey)
	return err
}
...
func (m *defaultMovieReleaseTopStatModel) Insert(ctx context.Context, data *MovieReleaseTopStat) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.ScopeKey, data.Level, data.Year, data.Quarter, data.Month, data.AggType, data.AggKey, data.AggId, data.AggName, data.CountAll, data.CountOwned, data.RankNo, data.CreatedOn, data.UpdatedOn, data.AggMode)
	}, rudyGcMovieReleaseTopStatAggModeScopeKeyAggTypeAggKeyKey, rudyGcMovieReleaseTopStatIdKey)
	return ret, err
}
...
func (m *defaultMovieReleaseTopStatModel) Update(ctx context.Context, newData *MovieReleaseTopStat) error {
	...
	_, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, newData.ScopeKey, newData.Level, newData.Year, newData.Quarter, newData.Month, newData.AggType, newData.AggKey, newData.AggId, newData.AggName, newData.CountAll, newData.CountOwned, newData.RankNo, newData.CreatedOn, newData.UpdatedOn, newData.AggMode, newData.Id)
	}, rudyGcMovieReleaseTopStatAggModeScopeKeyAggTypeAggKeyKey, rudyGcMovieReleaseTopStatIdKey)
	return err
}
