(function () {
    ...
    function loadPlan() {
        ...
        setLoading(true);
        request(API.plan + '?sc_name=' + encodeURIComponent(scName), {method: 'GET'})
            .then(function (data) {
                renderState(data);
            })
            .catch(function (err) {
    ...
    if (btnPrecheck) {
        btnPrecheck.addEventListener('click', function () {
            ...
            setLoading(true);
            requestJSON(API.precheck, 'POST', {sc_name: scName})
                .then(function (data) {
                    renderState(data);
    ...
    if (btnCommit) {
        btnCommit.addEventListener('click', function () {
            ...
            setLoading(true);
            requestJSON(API.commit, 'POST', {sc_name: scName})
                .then(function (data) {
                    renderState(data);
    ...
    if (btnReturn) {
        btnReturn.addEventListener('click', function () {
            ...
            setLoading(true);
            requestJSON(API.back, 'POST', {sc_name: scName})
                .then(function (data) {
                    renderState(data);
