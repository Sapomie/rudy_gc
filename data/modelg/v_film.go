...
type Film struct {
	...
	MovieName     string  `gorm:"column:movie_name;type:varchar(191);not null;uniqueIndex;index:idx_reldate_name,priority:2"`
	...
	ReleasingDate int64   `gorm:"column:releasing_date;not null;index:idx_reldate_name,priority:1"`
