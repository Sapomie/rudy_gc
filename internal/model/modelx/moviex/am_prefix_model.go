...
func (m *customAmPrefixModel) QueryRowsNoCacheCtx(ctx context.Context, dest any, query string, args ...any) error {
...
func (m *customAmPrefixModel) ListAllIDs(ctx context.Context) ([]int64, error) {
	const query = "SELECT id FROM am_prefix"
	var ids []int64
