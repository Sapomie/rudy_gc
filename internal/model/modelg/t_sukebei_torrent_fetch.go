...
type SukebeiTorrentFetch struct {
...
const sukebeiTorrentFetchTableName = "t_sukebei_torrent_fetch"

func (SukebeiTorrentFetch) TableName() string { return sukebeiTorrentFetchTableName }
