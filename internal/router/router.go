...
func New(d *dep.Dep) *gin.Engine {
	...
	r.GET("/wdir/:id", wdirHTML.DirDetail)
	...
	r.GET("/w-media-agg/birth/:year", wMediaAggHTML.BirthYear)
	r.GET("/w-media-agg/birth/:year/q/:q", wMediaAggHTML.BirthQuarter)
	r.GET("/w-media-agg/birth/:year/:month", wMediaAggHTML.BirthMonth)
	r.GET("/w-media-agg/birth/:year/:month/:day", wMediaAggHTML.BirthDay)
	...
	r.GET("/movie-agg-all/release/:year/:month/:day", aggHTML.MovieAggAllReleaseDay)
