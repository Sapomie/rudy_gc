...
func (l *CrawlLogic) FetchAndParseInventoryBySeed(ctx context.Context) error {
	l.deps.Log.WithContext(ctx).Info("FetchAndParseInventoryBySeed: begin")
	...
	l.deps.Log.WithContext(ctx).Info("FetchAndParseInventoryBySeed: done")
	return nil
}
